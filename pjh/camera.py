...
while(True):
    ...
    if(ret1) :
        ...
        K=np.array([[238.66743591, 0.0, 325.63486289], [0.0, 237.07012228, 252.80939684], [0.0, 0.0, 1.0]])
        D=np.array([[1.10005776e-01], [-6.16107688e-04], [1.90787247e-04], [-1.65665021e-02]])
