...
while(True):
    ...
    if key == ord('z'):
        cv2.imwrite('frame1_' + str(num) + '.png', frame1)
        cv2.imwrite('frame2_' + str(num) + '.png', frame2)
        cv2.imwrite('frame3_' + str(num) + '.png', frame3)
        cv2.imwrite('frame4_' + str(num) + '.png', frame4)
