...
def runBEV():
    ...
    while True:
        # ret1, front = cap1.read()
        # ret2, back = cap2.read()
        # ret3, left = cap3.read()
        # ret4, right = cap4.read()
        front = cv2.imread('C:/Users/multicampus/Desktop/front.png')
        back = cv2.imread('C:/Users/multicampus/Desktop/back.png')
        left = cv2.imread('C:/Users/multicampus/Desktop/left.png')
        right = cv2.imread('C:/Users/multicampus/Desktop/right.png')
